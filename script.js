...
(function(){
  ...
  // Reels: se autodesliza siempre. En carrusel (≤1000px, móvil o PC angosto) se mueve solo;
  // en PC ancho es cuadrícula sin scroll, así que el tick no hace nada. Al achicar la ventana
  // (aunque la página se cargara ancha) empieza a deslizarse solo, sin duplicar los videos.
