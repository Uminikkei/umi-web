...
function buildMenu(){
  const MAIN = {
    'Sushi':     { e:'🍣', cats:['Sushi Rolls','Rolls de Autor','Nigiris & Gunkans','Sashimi 3 Cortes'], ring:'Sushi' },
    'Ceviches':  { e:'🍋', cats:['Ceviches'],   ring:'Ceviches' },
    'Tiraditos': { e:'🐠', cats:['Tiraditos'],   ring:'Tiraditos' },
    'Ensaladas': { e:'🥗', cats:['Ensaladas','Entradas'], ring:'Ensaladas' },
    'Del Fuego': { e:'🍽️', cats:['Fuertes'],    ring:'Del Fuego' },
    'Postres':   { e:'🍮', cats:['Postres'],      ring:'Postres' },
    'Bebidas':   { e:'🥤', cats:['Bebidas'], ring:'Bebidas' }
  };
